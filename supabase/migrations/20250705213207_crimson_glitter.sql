/*
  # Add SOAP Entries Table

  1. New Tables
    - `soap_entries`
      - `id` (uuid, primary key)
      - `user_id` (uuid, foreign key to profiles)
      - `day` (integer, day of reading plan)
      - `scripture` (text, selected scripture verse)
      - `observation` (text, user's observations)
      - `application` (text, personal application)
      - `prayer` (text, prayer based on reading)
      - `reading_plan_day` (integer, specific day in reading plan)
      - `is_shared` (boolean, whether entry is shared publicly)
  ...
  3. Indexes
    - Add index on user_id and day for efficient queries
    - Add index on reading_plan_day for plan-based queries
*/
